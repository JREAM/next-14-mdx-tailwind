          ...
          <div className="p-4 col-span-6 md:col-span-4">
            ...
            <div className="mx-auto grid grid-cols-2 gap-x-8 gap-y-10">
              <div className="col-span-2 sm:col-span-1">
                <label className="block text-sm font-medium leading-6 text-gray-900">First name 1</label>
                <div className="mt-2">
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <div className="mt-2">
                  <input type="text" name="last-name"  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
              </div>
